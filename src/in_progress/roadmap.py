...
class MyHTMLParser(HTMLParser):
  ...
  def handle_starttag(self, tag, attrs):
    if tag == "a":
      print tag, attrs
      file = parse_file_name(attrs[0][1])
      if file:
...
def parse_data(root_address):
  parser = MyHTMLParser(root_address, experiments)
  f = urllib2.urlopen(root_address)
  data = f.read()
  print data
  parser.feed(data)

consolidated_narrow_peaks = "http://egg2.wustl.edu/roadmap/data/byFileType/peaks/consolidated/narrowPeak/"
consolidated_broad_peaks = "http://egg2.wustl.edu/roadmap/data/byFileType/peaks/consolidated/broadPeak/"
consolidated_signal = "http://egg2.wustl.edu/roadmap/data/byFileType/signal/consolidated/macs2signal/pval/" # -log10(p-value)
consolidated_signal_fold_change = "http://egg2.wustl.edu/roadmap/data/byFileType/signal/consolidated/macs2signal/foldChange/"
fractional_methylation_wgbs = "http://egg2.wustl.edu/roadmap/data/byDataType/dnamethylation/WGBS/FractionalMethylation_bigwig/"
read_coverage_wgbs = "http://egg2.wustl.edu/roadmap/data/byDataType/dnamethylation/WGBS/ReadCoverage_bigwig/"
fractional_methylation_rrbs = "http://egg2.wustl.edu/roadmap/data/byDataType/dnamethylation/RRBS/FractionalMethylation_bigwig/"
read_coverage_bigwig_rrbs = "http://egg2.wustl.edu/roadmap/data/byDataType/dnamethylation/RRBS/ReadCoverage_bigwig/"
fractional_methylation_mcrf = "http://egg2.wustl.edu/roadmap/data/byDataType/dnamethylation/mCRF/FractionalMethylation_bigwig/"
