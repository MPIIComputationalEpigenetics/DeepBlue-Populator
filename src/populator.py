...
class Populator:
  ...
  def insert_epigenetic_marks(self):
    ...
    epidb.add_epigenetic_mark("Chromatin State Segmentation",  "A common set of states across the cell types were learned by computationally integrating ChIP-seq data for nine factors plus input using a Hidden Markov Model (HMM). In total, fifteen states were used to segment the genome.")
    epidb.add_epigenetic_mark("mRNA-seq", "Messenger RNA")
    epidb.add_epigenetic_mark("flRNA-seq", "Full length RNA")
    epidb.add_epigenetic_mark("Input", "Experiment Input Data. It is not an epigenetic mark")
    epidb.add_epigenetic_mark("Control", "Experiment Control Data. It is not an epigenetic mark")
  ...
  def insert_technologies(self):
    ...
    epidb.add_technique("BisulfiteSeq", "Bisulfite sequencing or Bisulphite sequencing", {})
    epidb.add_technique("ChIPseq", "ChIP-sequencing", {})
    epidb.add_technique("ChIPseq Uniform", "ChIP-sequencing performed uniform processing on datasets produced by multiple data production groups in the ENCODE Consortium", {})
    epidb.add_technique("DNaseSeq", "DNase I hypersensitive sites sequencing", {})
    epidb.add_technique("DNaseSeq Uniform", "DNase I hypersensitive sites sequencing performed uniform processing on datasets produced by multiple data production groups in the ENCODE Consortium", {})
  ...
  def insert_projects(self):
    ...
    epidb.add_project("Blueprint Epigenetics", "BLUEPRINT - A BLUEPRINT of Haematopoietic Epigenomes")
    epidb.add_project("Mouse ENCODE", "The ENCODE Project: ENCyclopedia Of DNA Elements - Mouse")
