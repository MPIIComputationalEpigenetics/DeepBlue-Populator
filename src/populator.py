...
from genomes import hg19_info, mm9_info, mm10_info, hs37d5_info, GRCm38_info, GRCh38
...
class Populator:
    ...
    def insert_genomes(self):
        ...
        print epidb.add_genome("GRCm38", "Mouse Genome Assembly GRCm38 (compatible with mm10)", GRCm38mm10_info)
